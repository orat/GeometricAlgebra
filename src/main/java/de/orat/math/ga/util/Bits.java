...
public class Bits {
    ...
    /** 
     * returns in the index [0 32] of the lowest bit that is on in <code>i</code> 
     * (32 is returned if no bit is on at all (i == 0))
     * 
     * @param i
     * @return  lowest one bit; 0 if the first bit is on, 32 is returned if no bit is on at all
     */
    ...
    /** 
     * 'rounds' <code>i</code> to first power-of-2 integer larger than or equal 
     * to <code>i</code>
    ...
    /** 
     * 'rounds' <code>i</code> to first power-of-2 integer smallar than or equal 
     * to <code>i</code>
     * Treats <code>i</code> as unsigned int
     * 
     * @param i
